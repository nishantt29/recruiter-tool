...
function CandidateList() {
  ...
  const handleUpdateCandidate = () => {
    axios
      .put(
        `https://recruiter-tool.onrender.com/candidates/${candidateData.id}`,
        {
  ...
  const handleDeleteCandidate = (id) => {
    axios
      .delete(`https://recruiter-tool.onrender.com/candidates/${id}`)
      .then((response) => {
  ...
  const handleGetCandidateList = () => {
    axios
      .get("https://recruiter-tool.onrender.com/candidates", {
